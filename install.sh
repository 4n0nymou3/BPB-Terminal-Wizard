...
GREEN_DARK='\033[38;2;0;100;0m'
YELLOW='\033[38;2;255;255;0m'
BOLD='\033[1m'
NC='\033[0m'

echo -e "${GREEN_DARK}**********************************************${NC}"
echo -e "${GREEN_DARK}*                                            *${NC}"
echo -e "${GREEN_DARK}*        ${BOLD}BPB Terminal Wizard${NC}                 *${NC}"
echo -e "${GREEN_DARK}*                                            *${NC}"
echo -e "${GREEN_DARK}*  A tool to deploy BPB Panel in terminal    *${NC}"
echo -e "${GREEN_DARK}*  Created by ${BOLD}${YELLOW}Anonymous${NC} with thanks to ${BOLD}${YELLOW}BPB${NC}   *${NC}"
echo -e "${GREEN_DARK}*                                            *${NC}"
echo -e "${GREEN_DARK}**********************************************${NC}"
echo ""
